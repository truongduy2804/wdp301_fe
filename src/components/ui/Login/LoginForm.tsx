...
export default function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md flex flex-col justify-center animate-fade-in-up " style={{ animationDelay: "0.2s" }}>
      <div className="animated-border">
        <Card className="p-8 shadow-2xl border-0 bg-white relative z-10" style={{ boxShadow: "0 20px 60px rgba(0,0,0,0.08)" }}>
        <div className="space-y-6">
          {/* Header */}
          <div className="space-y-2 text-center animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            <h3 className="text-3xl font-extrabold text-gray-900">
              Đăng nhập
            </h3>
            <p className="text-gray-600 font-medium">Chào mừng bạn đến với GreenPoint</p>
          </div>

          {/* Login Form */}
          <form onSubmit={handleLogin} className="space-y-4">
            {/* Email Input */}
            <div className="space-y-2 animate-fade-in-up group" style={{ animationDelay: "0.3s" }}>
            ...
            {/* Password Input */}
            <div className="space-y-2 animate-fade-in-up group" style={{ animationDelay: "0.4s" }}>
              <div className="flex items-center justify-between">
                <label className="block text-sm font-semibold text-gray-700 group-hover:text-emerald-600 transition-colors duration-300">
                  Mật khẩu
                </label>
                <a href="#" className="text-sm text-emerald-600 hover:text-emerald-700 font-semibold hover:underline transition-all duration-300 hover:scale-105">
                  Quên mật khẩu?
                </a>
              </div>
              <div className="relative group/input">
            ...
            {/* Remember Me */}
            <div className="flex items-center gap-2 animate-fade-in-up group" style={{ animationDelay: "0.5s" }}>
              <input
                type="checkbox"
                id="remember"
              ...
              />
              <label htmlFor="remember" className="text-sm text-gray-600 cursor-pointer group-hover:text-emerald-600 font-medium transition-colors duration-300">
                Ghi nhớ tôi
              </label>
            </div>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
            ...
            >
              ...
              <span className="group-hover:text-blue-600 transition-colors duration-300">Google</span>
            </Button>
          </div>

          {/* Footer */}
          <div className="text-center pt-4 animate-fade-in-up" style={{ animationDelay: "0.9s" }}>
