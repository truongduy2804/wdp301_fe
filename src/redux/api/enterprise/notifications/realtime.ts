...
// This file handles realtime notification updates via Socket
...
// Stub until notifications API exists
export const applyRealtimeNotification = (
  dispatch: AppDispatch | any,
  payload: any,
) => {
  console.log("⚡ applyRealtimeNotification (STUB - API not available):", payload);
  // TODO: Implement when notificationsApi exists
};
