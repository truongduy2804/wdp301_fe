                  ...
                  <div className="mt-2 flex items-center gap-2 text-sm text-emerald-50">
                    ...
                    {googleMapUrl ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1 rounded-full border border-white/30 bg-white px-2.5 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100"
                      >
